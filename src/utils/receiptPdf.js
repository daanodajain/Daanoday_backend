...
// Renders a receipt as a PDF and streams it directly to `res`.
// Shared by the staff receipt route (receiptController.getPdf) and the
// customer-portal download route — both fetch+authorize the receipt
// themselves, then hand it (plus store settings) to this function.
const renderReceiptPdf = (receipt, settings, res) => {
